...
Plugin Name: Nemlis_plugin
 
Plugin URI:
 
Description: Footer For My Ecommerce Web Site
...
function custom_plugin_setting_page()
{
    ...
    add_menu_page('Custom Plugin', 'Copyright Footer', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form', plugins_url('custom-plugin/img/icon.png'));
...
{ ?>
    <div class="wrap">
        <h2>Nemli'S Footer Plugin Setting</h2>
        <p>Here you can edit the footer Informations</p>
